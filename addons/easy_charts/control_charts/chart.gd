...
func plot(functions: Array[Function], properties: ChartProperties = ChartProperties.new()) -> void:
	functions = functions
	chart_properties = properties
	
	theme.set("default_font", chart_properties.font)
	_canvas.prepare_canvas(chart_properties)
	plot_box.chart_properties = chart_properties
	function_legend.chart_properties = chart_properties
...
func load_functions(functions: Array[Function]) -> void:
	...
	for function in functions:
		# Load x and y values
		x.append(function.__x)
		y.append(function.__y)
